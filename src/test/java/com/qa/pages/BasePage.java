...
//        scrollObject.put("toVisible", "sdfnjksdnfkld");
	...
	public void swipeToSeeRightSideElementsOfScreen(int howManySwipes) {
		Dimension size = driver.manage().window().getSize();
		// calculate coordinates for vertical swipe
		int startVerticalY = (int) (size.height * 0.8);
		int endVerticalY = (int) (size.height * 0.21);
	...
	protected String getReferenceImageB64(String filename) throws URISyntaxException, IOException {
		// URL refImgUrl =
		// getClass().getClassLoader().getResource(System.getProperty("user.dir") +
		// File.separator + "src" + File.separator + "test"
		// + File.separator + "resources" + File.separator + "images" + File.separator
		// +filename);
		// URL refImgUrl =
		// getClass().getClassLoader().getResource("/src/test/resources/images/"+filename);
    ...
    public String removeAllSpacesAndSpecialChar(String str) {
