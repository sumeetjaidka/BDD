...
public class KooCreationPage extends BasePage{
	...
	@FindBy(id="com.koo.app:id/post_text_view")
	public WebElement koocreationBox;

	@FindBy(id="com.koo.app:id/creation_view")
	//@FindBy(id="com.koo.app:id/post_text_view")
	public WebElement kooLandingPage;

	@FindBy(id="com.koo.app:id/circular_fab")
	public WebElement circularFabCreateKooButton;
...
//	
	...
	@FindBy(id="com.koo.app:id/koo_create_add_view")
	public WebElement addMoreButton;
	
	@FindBy(id="com.koo.app:id/done_imageview")
	public WebElement doneImage;

	@FindBy(id="com.koo.app:id/nextButton")
	public WebElement nextButtonInImageSelection;

	@FindBy(id="com.koo.app:id/add_image_textview")
	public WebElement imageNumberHolder;
	...
	@FindBy(id="com.koo.app:id/ivCrop")
	public WebElement imageCropButton;

	@FindBy(id="com.koo.app:id/edit_preview")
	public WebElement imageEditButton;

	@FindBy(id="com.koo.app:id/action_delete")
	public WebElement deleteButton;

	@FindBy(id="com.koo.app:id/ivDelete")
	...
	@FindBy(xpath ="//android.widget.TextView[@text='Pictures']")
	public WebElement selectingScreenshotsFromGallery;
	...
	@FindBy(id="com.koo.app:id/noBtn")
	public WebElement kooPostNotNowBtnInPopUp;

	@FindBy(id ="com.koo.app:id/yesBtn")
	...
	public void navigateToKooCreationScreen() throws InterruptedException {
		...
		waitForVisibility(koocreationBox);
	}

	public void navigateToKooLandingPage() throws InterruptedException {
		Thread.sleep(10000);
		//waitForVisibility(whatsYourMindTextBox);
		waitForVisibility(kooLandingPage);
	}
...
/*		waitForVisibility(allowButtonOnConfirmationPopup);
		...
		click(allowButtonOnConfirmationPopup);
		Thread.sleep(1000);*/
		permissionHandler.masterPermissionHandler();
		Thread.sleep(2000);
	...
	public void verify_user_is_able_to_post_koo_only_by_entering_title() throws Exception {
		...
		click(settingsIcon);
		waitForVisibility(applyForAllKoosButton);
	...
	public void verify_user_is_able_to_rekoo_with_comment_on_tapping_on_rekoo_button_and_selecting_rekoo_with_comment() throws Exception {
		...
		permissionHandler.dismissRekooCommentPopUp("yes");
	...
	public void verify_user_should_able_to_edit_poll_until_there_are_no_action_on_poll() throws InterruptedException {
		...
		Thread.sleep(2000);
		waitForVisibility(pollCreationTextBox1);
		clear(pollCreationTextBox1);
		clear(pollCreationTextBox2);
	...
	public void onTappingKooCreationButtonUserShouldLandOnMultiLingualKooCreationScreenFromFeedOwnProfileCreateYourFirstKooButton() throws InterruptedException {
		waitForVisibility(addButton);
		click(addButton);
		waitForVisibility(backButton);
	...
	public void verify_button_shown_in_active_languages_title_box_tapping_the_button_translates_text_from_original_language_should_load_in_title() throws InterruptedException {
		...
		click(addButton);
		waitForVisibility(whatsYourMindTextBox);
		sendKeys(whatsYourMindTextBox,"Checking language conversion");
		click(languageSelectionPlusIcon);
	...
	public void createMLKKoo() throws InterruptedException {
		waitForVisibility(addButton);
		click(addButton);
		//waitForVisibility(koocreationBox);
		if(!isElementPresent(HindiLaguageBttn)) {
			click(languageSelectionPlusIcon);
			waitForVisibility(hindiLanguageButton);
			click(hindiLanguageButton);
			click(doneButton);
		}
		waitForVisibility(HindiLaguageBttn);
		sendKeys(whatsYourMindTextBox,"Creating a new MLK Post");
		click(HindiLaguageBttn);
		Thread.sleep(1000);
		waitForVisibility(translateFromOrignalLangugeButton);
		Assert.assertTrue(translateFromOrignalLangugeButton.getText().equalsIgnoreCase("Translate from original"));
		click(translateFromOrignalLangugeButton);
	...
	public void verifyAvailableInTheseManyLanguagesTextShouldShowOnTheKooCardInFeedAsWellAsOnKooDetailedScreenWithBlueColourAndGlobeIcon() throws Exception {
		...
		{
			System.out.println("Language identifiers missing ");
		}
	}
...
//		Assert.assertTrue(isElementPresent(recorderTimer));
	...
	public void creatingPostWithAudioAndImage() throws InterruptedException {
		...
		try {
			...
			System.out.println("None of the permissions matched");
			e.getStackTrace();
		}
...
Thread.sleep(4000);
		...
		kooCreationTextBox.sendKeys("Image and Audio post");
		waitForVisibility(postButton);
		click(postButton);
...
//		Assert.assertTrue(isElementPresent(recorderTimer));
	...
	//Notifcation 
		...
		public void verify_Like_Comment_AndRekooPost() throws InterruptedException {
			waitForVisibility(userProfileIcon);
			click(notificationButton);
			Thread.sleep(3000);
			waitForVisibility(likeNotification);
			Thread.sleep(3000);
...
//			Assert.assertTrue(isElementPresent(commentNotification));
	...
	public void IVerifyUserIsAbleToPostKooOnlyByRecordingVideo() throws InterruptedException {
		...
		click(postButton);
		Thread.sleep(10000); //waiting for post to go through
		waitForVisibility(AddPollButton);
		Thread.sleep(3000);
		new HomePage().VerifyByDeletingTheGeneratedPoll();
	...
	public void IVerifyUserIsAbleToPostKooByAddingInCombinationsOfTitleAndVideo() throws InterruptedException {
		...
		click(postButton);
		Thread.sleep(10000);
		Assert.assertTrue(isElementPresent(circularFabCreateKooButton));
		//waitForVisibility(AddPollButton);
		Thread.sleep(3000);	
	}
	...
	public void IVerifyUserIsAbleToPostKooByAddingInCombinationsOftitleAudioAndImage() throws InterruptedException {
		...
		waitForVisibility(postButton);
		click(postButton);
		Thread.sleep(10000); //waiting for post to complete successfully
		waitForVisibility(AddPollButton);
		Thread.sleep(3000);	
	...
	public void IVerifyOnCapturingTheImageDoneAndCancelButtonWithImageCropperShouldAppear() throws InterruptedException {
		...
		permissionHandler.openCamera();
		permissionHandler.captureImage();
		waitForVisibility(pollIcon);
		Assert.assertTrue(imageEditButton.isDisplayed());
	}
	...
	public void IVerifIVerifyonSelectingEveryoneAllTheUsersUsingKooAppTheyCanCommentonThatRespectiveKooyKooCommentsOffFeatureForScenarios() throws Exception {
		...
		new CommonStepsDef().logInUsingTestMobileNumber("1111100014");
		waitForVisibility(Profileicon);
	...
	public void IVerifyUserShouldBeAbletoSelectAnyofTheGalleryType() throws InterruptedException {
		...
		for(int i=0;i<3;i++) {
			Thread.sleep(10000);
			System.out.println("Waiting for optimization ");//+ previewPage.isDisplayed() + previewPage.isEnabled());
	...
	public void IVerifyEditRemoveandPlayButtonsonTheAddedVideo() throws InterruptedException {
		...
		Assert.assertTrue(isElementPresent(editButton));	
		Assert.assertTrue(isElementPresent(playbutton));
		//video duration needs scrolling
		try {
			if(isElementPresent(videoDuration)) {
				Assert.assertTrue(isElementPresent(videoDuration));
			}
			else
			{
		...
		{
			System.out.println("Video duration not seen");
		}
	...
	public void IVerifyUserShouldNotbeAbletoPostaKooOnlybyAaddingaVideoWithoutTitle() throws InterruptedException {
		...
		permissionHandler.chooseVideo(2);
permissionHandler.saveVideo();
...
//		click(cameraImages);
	...
	public void IVerifytheAddImageButtonatTheBottomUntillUserAddsMaximumof4Images() throws InterruptedException {
		...
		permissionHandler.chooseImage(0); //choose first image
		...
		click(addMoreButton);
		waitForVisibility(phoneGallary);
		permissionHandler.switchToImageAlbum();

		for(int i=1;i<4;i++) {
			permissionHandler.chooseMultipleImages(i,1);
			waitForVisibility(imageNumberHolder);
			Assert.assertTrue(isElementPresent(imageNumberHolder));
			Assert.assertTrue(multipleAddButton.getText().equalsIgnoreCase(i+1 +"/4"));
		}

		Assert.assertTrue(isElementPresent(nextButtonInImageSelection));
		click(nextButtonInImageSelection);
		waitForVisibility(CreatePollPage);
		Assert.assertTrue(!isElementPresent(addMoreButton));
	...
	//new by sumeet
	public void createfirstKooPost(String post) throws InterruptedException {
		waitForVisibility(whatsYourMindText);
		sendKeys(whatsYourMindTextBox, post);
		Thread.sleep(5000);
		click(postButton);
		waitForVisibility(kooPostNotNowBtnInPopUp);
		click(kooPostNotNowBtnInPopUp);
		Thread.sleep(5000);

	}
	public void DeleteKooCreated() throws InterruptedException {
		waitForVisibility(twoDotButton);
		click(twoDotButton);
		waitForVisibility(deleteKooPost);
		click(deleteKooPost);
	...
	public void iVerifyClickOnYesButton() throws InterruptedException {
		waitForVisibility(YesButton);
		click(YesButton);

	}
	public void iVerifyClickOnPhoto() throws InterruptedException {
		waitForVisibility(ClickOnPhoto);
		click(ClickOnPhoto);
...
//		click(cameraImages);
	...
	public void InputTitle(String post) throws InterruptedException {
		waitForVisibility(whatsYourMindText);
		sendKeys(whatsYourMindTextBox, post);
		Thread.sleep(5000);
		click(postButton);
