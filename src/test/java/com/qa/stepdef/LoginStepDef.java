...
public class LoginStepDef {
	...
	@When("^I Enter New Email id \"([^\"]*)\" and click on Proceed")
	public void iEnterNewEmailId(String email) throws InterruptedException {
		new LoginPage().enterNewEmailID(email);
	}
